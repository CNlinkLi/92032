...
static const _RosCanMotorSta_type_support_symbol_names_t _RosCanMotorSta_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosmsg, msg, RosCanMotorSta)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosmsg, msg, RosCanMotorSta)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rosmsg, msg, RosCanMotorSta)() {
  return &::rosmsg::msg::rosidl_typesupport_c::RosCanMotorSta_message_type_support_handle;
}
