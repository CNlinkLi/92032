...
#include "rosmsg/msg/detail/motor_input_msg__rosidl_typesupport_fastrtps_c.h"
...
using _MotorInputMsg__ros_msg_type = rosmsg__msg__MotorInputMsg;
...
{
  const _MotorInputMsg__ros_msg_type * ros_message = static_cast<const _MotorInputMsg__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosmsg__msg__MotorInputMsg;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rosmsg__msg__MotorInputMsg * ros_message = static_cast<const rosmsg__msg__MotorInputMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rosmsg__msg__MotorInputMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rosmsg__msg__MotorInputMsg * ros_message = static_cast<rosmsg__msg__MotorInputMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rosmsg__msg__MotorInputMsg(cdr, ros_message);
}

static uint32_t _MotorInputMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosmsg__msg__MotorInputMsg(
...
static size_t _MotorInputMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosmsg__msg__MotorInputMsg(
...
static message_type_support_callbacks_t __callbacks_MotorInputMsg = {
  "rosmsg::msg",
  "MotorInputMsg",
...
static rosidl_message_type_support_t _MotorInputMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MotorInputMsg,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosmsg, msg, MotorInputMsg)() {
  return &_MotorInputMsg__type_support;
}
