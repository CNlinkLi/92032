...
static const _MotorInputMsg_type_support_symbol_names_t _MotorInputMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosmsg, msg, MotorInputMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosmsg, msg, MotorInputMsg)),
  }
};
...
{
  return &::rosmsg::msg::rosidl_typesupport_cpp::MotorInputMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosmsg, msg, MotorInputMsg)() {
  return get_message_type_support_handle<rosmsg::msg::MotorInputMsg>();
}
