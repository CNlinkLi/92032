...
#include "rosmsg/msg/detail/ros_can_imu_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rosmsg::msg::RosCanImuMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rosmsg::msg::RosCanImuMsg & ros_message)
{
  // Member: qurd_x
  cdr >> ros_message.qurd_x;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosmsg
max_serialized_size_RosCanImuMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosmsg::msg::RosCanImuMsg;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rosmsg
max_serialized_size_key_RosCanImuMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const rosmsg::msg::RosCanImuMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosmsg::msg::RosCanImuMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RosCanImuMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rosmsg::msg::RosCanImuMsg *>(
...
static size_t _RosCanImuMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RosCanImuMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RosCanImuMsg__callbacks = {
  "rosmsg::msg",
  "RosCanImuMsg",
...
static rosidl_message_type_support_t _RosCanImuMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RosCanImuMsg__callbacks,
...
{
  return &rosmsg::msg::typesupport_fastrtps_cpp::_RosCanImuMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosmsg, msg, RosCanImuMsg)() {
  return &rosmsg::msg::typesupport_fastrtps_cpp::_RosCanImuMsg__handle;
}
